...
export interface IMerkleDistributorInterface extends Interface {
  getFunction(
    nameOrSignature: "claim" | "isClaimed" | "merkleRoot" | "token"
  ): FunctionFragment;
...
export interface IMerkleDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): IMerkleDistributor;
